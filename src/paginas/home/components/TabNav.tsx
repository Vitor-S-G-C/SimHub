import { LayoutDashboard, Users, Phone, UserSearch, PhoneCall, Receipt, UserPlus } from 'lucide-react'
...
const tabs: Array<{ id: Aba; label: string; icon: React.ReactNode; adminOnly?: boolean }> = [
  ...
  { id: 'coordenadores', label: 'Coordenadores', icon: <UserPlus size={20} />, adminOnly: true },
]

export function TabNav({ abaAtiva, onChange, role }: TabNavProps) {
